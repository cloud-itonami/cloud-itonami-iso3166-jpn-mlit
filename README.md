# cloud-itonami-iso3166-jpn-mlit

Open ISO 3166 Agency Blueprint for **JPN-MLIT**: Ministry of Land, Infrastructure, Transport and Tourism
(国土交通省, MLIT) — a Japan-agency-level LEAF under
...
gets a Compliance Advisor + independent **Construction-Licensing Compliance Governor** to
navigate construction-business licensing (建設業許可) under the Construction Business Act (建設業法) for an operator bidding on public-works infrastructure contracts, and building-code (建築基準法) compliance for a delivered structure.
...
operator intake + prior filing/compliance history
        |
        v
Compliance Advisor -> Construction-Licensing Compliance Governor -> compliance draft, or human sign-off
        |
        v
...
- **Not Ministry of Land, Infrastructure, Transport and Tourism (国土交通省) itself, and not the
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official MLIT source and route final filings to
...
(code `JPN-MLIT`, `:parent "JPN"`, cross-referenced to ooyake's
`gov.jpn.mlit`). Required capabilities:
